public class DifficultySettings {
    ...
    private static final DifficultyConfig EASY_CONFIG = new DifficultyConfig(10000, 5, 2000, 1000, 800, 5, 6, 8);
    private static final DifficultyConfig MEDIUM_CONFIG = new DifficultyConfig(15000, 4, 1500, 1000, 800, 7, 9, 10);
    private static final DifficultyConfig HARD_CONFIG = new DifficultyConfig(20000, 3, 1000, 800, 600, 8, 11, 12);
