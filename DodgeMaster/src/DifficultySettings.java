public class DifficultySettings {
    ...
    private static final DifficultyConfig EASY_CONFIG = new DifficultyConfig(10000, 5, 4000, 3000, 2000, 5, 7, 10);
    private static final DifficultyConfig MEDIUM_CONFIG = new DifficultyConfig(15000, 4, 3000, 2000, 1500, 7, 9, 12);
    private static final DifficultyConfig HARD_CONFIG = new DifficultyConfig(20000, 3, 2000, 1500, 1000, 10, 12, 15);
